// Full dataset it1 — standalone ro_0008 (N_RO=8)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=8).
...
// --- Standalone ring oscillator array (N_RO=8) ---
(* DONT_TOUCH = "TRUE" *) wire [7:0] ro_out;
ring_osc_array #(.N_RO(8)) inst_ro_array (
