// Full dataset it1 — standalone ro_0048 (N_RO=48)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=48).
...
// --- Standalone ring oscillator array (N_RO=48) ---
(* DONT_TOUCH = "TRUE" *) wire [47:0] ro_out;
ring_osc_array #(.N_RO(48)) inst_ro_array (
