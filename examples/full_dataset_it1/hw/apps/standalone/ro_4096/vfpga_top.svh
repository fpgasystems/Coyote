// Full dataset it1 — standalone ro_4096 (N_RO=4096)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=4096).
...
// --- Standalone ring oscillator array (N_RO=4096) ---
(* DONT_TOUCH = "TRUE" *) wire [4095:0] ro_out;
ring_osc_array #(.N_RO(4096)) inst_ro_array (
