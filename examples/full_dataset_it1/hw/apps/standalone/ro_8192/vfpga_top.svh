// Full dataset it1 — standalone ro_8192 (N_RO=8192)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=8192).
...
// --- Standalone ring oscillator array (N_RO=8192) ---
(* DONT_TOUCH = "TRUE" *) wire [8191:0] ro_out;
ring_osc_array #(.N_RO(8192)) inst_ro_array (
