# FP03_upper — Upper 4 rows only of U55C user area
# Clock regions Y7-Y10, full width X0-X5
...
resize_pblock [get_pblocks pblock_inst_user_wrapper_0] -add {CLOCKREGION_X0Y7:CLOCKREGION_X5Y10}
