# FP04_lower — Lower 7 rows only of U55C user area
# Clock regions Y0-Y6, full width X0-X5
...
resize_pblock [get_pblocks pblock_inst_user_wrapper_0] -add {CLOCKREGION_X0Y0:CLOCKREGION_X5Y6}
