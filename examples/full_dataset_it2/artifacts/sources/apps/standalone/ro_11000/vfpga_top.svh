// Full dataset iteration 2 — standalone ro_11000 (N_RO=11000)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=11000).
...
// --- Standalone ring oscillator array (N_RO=11000) ---
(* DONT_TOUCH = "TRUE" *) wire [10999:0] ro_out;
ring_osc_array #(.N_RO(11000)) inst_ro_array (
