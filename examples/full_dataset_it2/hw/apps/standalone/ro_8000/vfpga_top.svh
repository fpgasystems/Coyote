// Full dataset iteration 2 — standalone ro_8000 (N_RO=8000)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=8000).
...
// --- Standalone ring oscillator array (N_RO=8000) ---
(* DONT_TOUCH = "TRUE" *) wire [7999:0] ro_out;
ring_osc_array #(.N_RO(8000)) inst_ro_array (
