// Full dataset iteration 2 — standalone ro_9000 (N_RO=9000)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=9000).
...
// --- Standalone ring oscillator array (N_RO=9000) ---
(* DONT_TOUCH = "TRUE" *) wire [8999:0] ro_out;
ring_osc_array #(.N_RO(9000)) inst_ro_array (
