// Full dataset iteration 3 — standalone ro_17000 (N_RO=17000)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=17000).
...
// --- Standalone ring oscillator array (N_RO=17000) ---
(* DONT_TOUCH = "TRUE" *) wire [16999:0] ro_out;
ring_osc_array #(.N_RO(17000)) inst_ro_array (
