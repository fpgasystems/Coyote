// Full dataset iteration 3 — standalone ro_8750 (N_RO=8750)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=8750).
...
// --- Standalone ring oscillator array (N_RO=8750) ---
(* DONT_TOUCH = "TRUE" *) wire [8749:0] ro_out;
ring_osc_array #(.N_RO(8750)) inst_ro_array (
