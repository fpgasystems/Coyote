// Full dataset iteration 3 — standalone ro_11750 (N_RO=11750)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=11750).
...
// --- Standalone ring oscillator array (N_RO=11750) ---
(* DONT_TOUCH = "TRUE" *) wire [11749:0] ro_out;
ring_osc_array #(.N_RO(11750)) inst_ro_array (
