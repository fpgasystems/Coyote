// Full dataset iteration 4 - big-hammer RO - standalone ro_32600 (N_RO=32600)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=32600).
...
// --- Standalone ring oscillator array (N_RO=32600) ---
(* DONT_TOUCH = "TRUE" *) wire [32599:0] ro_out;
ring_osc_array #(.N_RO(32600)) inst_ro_array (
