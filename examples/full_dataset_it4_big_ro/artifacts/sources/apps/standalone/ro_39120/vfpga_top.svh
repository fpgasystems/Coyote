// Full dataset iteration 4 - big-hammer RO - standalone ro_39120 (N_RO=39120)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=39120).
...
// --- Standalone ring oscillator array (N_RO=39120) ---
(* DONT_TOUCH = "TRUE" *) wire [39119:0] ro_out;
ring_osc_array #(.N_RO(39120)) inst_ro_array (
