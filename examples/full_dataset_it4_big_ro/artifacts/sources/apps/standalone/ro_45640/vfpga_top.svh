// Full dataset iteration 4 - big-hammer RO - standalone ro_45640 (N_RO=45640)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=45640).
...
// --- Standalone ring oscillator array (N_RO=45640) ---
(* DONT_TOUCH = "TRUE" *) wire [45639:0] ro_out;
ring_osc_array #(.N_RO(45640)) inst_ro_array (
