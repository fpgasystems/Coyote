// Full dataset iteration 4 - big-hammer RO - standalone ro_71720 (N_RO=71720)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=71720).
...
// --- Standalone ring oscillator array (N_RO=71720) ---
(* DONT_TOUCH = "TRUE" *) wire [71719:0] ro_out;
ring_osc_array #(.N_RO(71720)) inst_ro_array (
