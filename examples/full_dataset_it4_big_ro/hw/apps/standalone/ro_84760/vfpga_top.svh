// Full dataset iteration 4 - big-hammer RO - standalone ro_84760 (N_RO=84760)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=84760).
...
// --- Standalone ring oscillator array (N_RO=84760) ---
(* DONT_TOUCH = "TRUE" *) wire [84759:0] ro_out;
ring_osc_array #(.N_RO(84760)) inst_ro_array (
