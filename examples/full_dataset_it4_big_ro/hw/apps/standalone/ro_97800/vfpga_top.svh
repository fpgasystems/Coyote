// Full dataset iteration 4 - big-hammer RO - standalone ro_97800 (N_RO=97800)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=97800).
...
// --- Standalone ring oscillator array (N_RO=97800) ---
(* DONT_TOUCH = "TRUE" *) wire [97799:0] ro_out;
ring_osc_array #(.N_RO(97800)) inst_ro_array (
