...
#include "prod_res256_manualA_coyote_accel.h"
...
void prod_res256_manualA_coyote_accel(
    ...
    #pragma HLS STREAM variable=layer31_out depth=4
    ...
    #pragma HLS STREAM variable=layer33_out depth=4

    hls::stream<layer35_t> layer35_out("layer35_out");
    #pragma HLS STREAM variable=layer35_out depth=4
