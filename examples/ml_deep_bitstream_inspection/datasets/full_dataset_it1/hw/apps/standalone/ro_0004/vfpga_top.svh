// Full dataset it1 — standalone ro_0004 (N_RO=4)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=4).
...
// --- Standalone ring oscillator array (N_RO=4) ---
(* DONT_TOUCH = "TRUE" *) wire [3:0] ro_out;
ring_osc_array #(.N_RO(4)) inst_ro_array (
