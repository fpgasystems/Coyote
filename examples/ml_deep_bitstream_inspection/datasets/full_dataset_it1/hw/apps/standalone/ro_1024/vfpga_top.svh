// Full dataset it1 — standalone ro_1024 (N_RO=1024)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=1024).
...
// --- Standalone ring oscillator array (N_RO=1024) ---
(* DONT_TOUCH = "TRUE" *) wire [1023:0] ro_out;
ring_osc_array #(.N_RO(1024)) inst_ro_array (
