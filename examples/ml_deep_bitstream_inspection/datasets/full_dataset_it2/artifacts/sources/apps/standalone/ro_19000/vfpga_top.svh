// Full dataset iteration 2 — standalone ro_19000 (N_RO=19000)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=19000).
...
// --- Standalone ring oscillator array (N_RO=19000) ---
(* DONT_TOUCH = "TRUE" *) wire [18999:0] ro_out;
ring_osc_array #(.N_RO(19000)) inst_ro_array (
