// Full dataset iteration 2 — standalone ro_22000 (N_RO=22000)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=22000).
...
// --- Standalone ring oscillator array (N_RO=22000) ---
(* DONT_TOUCH = "TRUE" *) wire [21999:0] ro_out;
ring_osc_array #(.N_RO(22000)) inst_ro_array (
