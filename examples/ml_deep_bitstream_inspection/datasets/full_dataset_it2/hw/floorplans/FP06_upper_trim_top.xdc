# FP06_upper_trim_top — Upper region trimmed at top (Y7-Y9)
# Upper: X0Y7:X5Y9 (row Y10 removed), Lower: X0Y0:X3Y6 (same as FP00)
...
resize_pblock [get_pblocks pblock_inst_user_wrapper_0] -add {CLOCKREGION_X0Y7:CLOCKREGION_X5Y9 CLOCKREGION_X0Y0:CLOCKREGION_X3Y6}
