// Full dataset iteration 3 — standalone ro_10250 (N_RO=10250)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=10250).
...
// --- Standalone ring oscillator array (N_RO=10250) ---
(* DONT_TOUCH = "TRUE" *) wire [10249:0] ro_out;
ring_osc_array #(.N_RO(10250)) inst_ro_array (
