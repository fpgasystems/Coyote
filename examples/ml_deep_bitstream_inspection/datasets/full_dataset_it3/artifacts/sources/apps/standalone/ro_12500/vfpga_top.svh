// Full dataset iteration 3 — standalone ro_12500 (N_RO=12500)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=12500).
...
// --- Standalone ring oscillator array (N_RO=12500) ---
(* DONT_TOUCH = "TRUE" *) wire [12499:0] ro_out;
ring_osc_array #(.N_RO(12500)) inst_ro_array (
