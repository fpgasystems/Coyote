// Full dataset iteration 4 - big-hammer RO - standalone ro_108666 (N_RO=108666)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=108666).
...
// --- Standalone ring oscillator array (N_RO=108666) ---
(* DONT_TOUCH = "TRUE" *) wire [108665:0] ro_out;
ring_osc_array #(.N_RO(108666)) inst_ro_array (
