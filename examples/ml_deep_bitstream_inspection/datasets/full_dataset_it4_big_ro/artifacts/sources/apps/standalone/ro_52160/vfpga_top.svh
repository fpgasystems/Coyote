// Full dataset iteration 4 - big-hammer RO - standalone ro_52160 (N_RO=52160)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=52160).
...
// --- Standalone ring oscillator array (N_RO=52160) ---
(* DONT_TOUCH = "TRUE" *) wire [52159:0] ro_out;
ring_osc_array #(.N_RO(52160)) inst_ro_array (
