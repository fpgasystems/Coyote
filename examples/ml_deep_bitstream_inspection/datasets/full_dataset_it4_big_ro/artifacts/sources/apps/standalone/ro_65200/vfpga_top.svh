// Full dataset iteration 4 - big-hammer RO - standalone ro_65200 (N_RO=65200)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=65200).
...
// --- Standalone ring oscillator array (N_RO=65200) ---
(* DONT_TOUCH = "TRUE" *) wire [65199:0] ro_out;
ring_osc_array #(.N_RO(65200)) inst_ro_array (
