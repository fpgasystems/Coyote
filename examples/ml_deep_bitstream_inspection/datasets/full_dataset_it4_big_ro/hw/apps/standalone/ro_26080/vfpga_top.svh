// Full dataset iteration 4 - big-hammer RO - standalone ro_26080 (N_RO=26080)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=26080).
...
// --- Standalone ring oscillator array (N_RO=26080) ---
(* DONT_TOUCH = "TRUE" *) wire [26079:0] ro_out;
ring_osc_array #(.N_RO(26080)) inst_ro_array (
