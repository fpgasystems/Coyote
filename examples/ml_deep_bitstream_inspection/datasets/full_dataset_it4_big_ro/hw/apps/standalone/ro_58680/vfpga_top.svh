// Full dataset iteration 4 - big-hammer RO - standalone ro_58680 (N_RO=58680)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=58680).
...
// --- Standalone ring oscillator array (N_RO=58680) ---
(* DONT_TOUCH = "TRUE" *) wire [58679:0] ro_out;
ring_osc_array #(.N_RO(58680)) inst_ro_array (
