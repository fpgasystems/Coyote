// Full dataset iteration 4 - big-hammer RO - standalone ro_78240 (N_RO=78240)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=78240).
...
// --- Standalone ring oscillator array (N_RO=78240) ---
(* DONT_TOUCH = "TRUE" *) wire [78239:0] ro_out;
ring_osc_array #(.N_RO(78240)) inst_ro_array (
