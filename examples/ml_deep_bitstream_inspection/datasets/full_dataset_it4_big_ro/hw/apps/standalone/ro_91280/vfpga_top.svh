// Full dataset iteration 4 - big-hammer RO - standalone ro_91280 (N_RO=91280)
// Stream passthrough (recv[0] -> send[0]) + ring_osc_array (N_RO=91280).
...
// --- Standalone ring oscillator array (N_RO=91280) ---
(* DONT_TOUCH = "TRUE" *) wire [91279:0] ro_out;
ring_osc_array #(.N_RO(91280)) inst_ro_array (
