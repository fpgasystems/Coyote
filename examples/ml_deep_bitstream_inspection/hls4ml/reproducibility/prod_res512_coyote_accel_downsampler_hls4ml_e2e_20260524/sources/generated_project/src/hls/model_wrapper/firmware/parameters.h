...
struct config2 : nnet::padding2d_config {
    ...
    static const unsigned out_height = 516;
    static const unsigned out_width = 516;
...
struct config3 : nnet::conv2d_config {
    ...
    static const unsigned in_height = 516;
    static const unsigned in_width = 516;
    static const unsigned n_chan = 1;
    ...
    static const unsigned min_height = 516;
    static const unsigned min_width = 516;
...
struct relu_config15 : nnet::activ_config {
    static const unsigned n_in = 98304;
    static const unsigned table_size = 1024;
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 1;
...
struct config18_mult : nnet::dense_config {
    ...
    static const unsigned reuse_factor = 36;
    static const unsigned strategy = nnet::resource;
    static const unsigned n_zeros = 2592;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
...
struct config23_mult : nnet::dense_config {
    ...
    static const unsigned reuse_factor = 36;
    static const unsigned strategy = nnet::resource;
    static const unsigned n_zeros = 3456;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
...
struct config28_mult : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned n_zeros = 4608;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv5_accum_t accum_t;
...
struct relu_config30 : nnet::activ_config {
    ...
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 1;
    typedef act5_table_t table_t;
};

// pool5
struct config31 : nnet::pooling2d_config {
    static const unsigned in_height = 8;
    static const unsigned in_width = 8;
    static const unsigned n_filt = 32;
    static const unsigned stride_height = 2;
...
const ap_uint<config33::filt_height * config33::filt_width> config33::pixels[] = {0};
...
struct config36 : nnet::pooling2d_config {
    ...
    static const nnet::conv_implementation implementation = nnet::conv_implementation::linebuffer;
    static const unsigned reuse_factor = 1;
    typedef pool6_accum_t accum_t;
};

// gap
struct config37 : nnet::pooling2d_config {
