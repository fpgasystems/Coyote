...
void model_wrapper (
    ...
    #pragma HLS STREAM variable=bitstream_input depth=262144

    hls::stream<result_t> layer39_out("layer39_out");
    ...
    prod_res512_manualA_coyote_accel(bitstream_input,layer39_out);
    nnet::data_to_axi_stream<result_t, float, 1, COYOTE_AXI_STREAM_BITS, 8 * sizeof(float)>(layer39_out, data_out);
