...
#include "zero_in_coyote_accel.h"
...
void zero_in_coyote_accel(
    ...
    nnet::pooling2d_cl<layer26_t, layer27_t, config27>(layer26_out, layer27_out); // gap

    nnet::dense<layer27_t, result_t, config29>(layer28_out, layer29_out, w29, b29); // output_dense
