...
SESSION="${1:-hls4ml_recompute_results_pre_recovery_$(date +%Y%m%d_%H%M%S)}"
TS="$(date +%Y%m%d_%H%M%S)"
LOG_ROOT="$ROOT/logs/recompute_results_pre_recovery/$TS"
RUNNER="$ROOT/scripts/recompute_results_pre_recovery.sh"
