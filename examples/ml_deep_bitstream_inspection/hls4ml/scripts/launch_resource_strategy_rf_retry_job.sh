...
if [ "$rc" -eq 0 ]; then
  notify "resource RF retry complete: $summary session=$SESSION_NAME results=/pub/scratch/sdeheredia/Coyote/examples/ml_deep_bitstream_inspection/hls4ml/results/selected_feasible_candidates_resource_strategy"
