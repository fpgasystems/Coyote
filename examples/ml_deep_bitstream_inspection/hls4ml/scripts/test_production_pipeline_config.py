...
DEFAULT_CONFIGS = [
    EXAMPLE_ROOT / "configs/hls4ml_production/res256_layers7_W8A8_P50_manualA_production.yaml",
    EXAMPLE_ROOT / "configs/hls4ml_production/res512_layers7_W8A8_P50_manualA_production.yaml",
]
