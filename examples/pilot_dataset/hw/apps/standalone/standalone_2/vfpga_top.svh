...
// Stream passthrough (recv[0] → send[0]) + ring_osc_array (N_RO=200).
...
// --- Standalone ring oscillator array (N_RO=200) ---
(* DONT_TOUCH = "TRUE" *) wire [199:0] ro_out;
ring_osc_array #(.N_RO(200)) inst_ro_array (
