...
// Stream passthrough (recv[0] → send[0]) + ring_osc_array (N_RO=500).
...
// --- Standalone ring oscillator array (N_RO=500) ---
(* DONT_TOUCH = "TRUE" *) wire [499:0] ro_out;
ring_osc_array #(.N_RO(500)) inst_ro_array (
