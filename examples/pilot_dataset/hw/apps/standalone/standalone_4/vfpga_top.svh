...
// Stream passthrough (recv[0] → send[0]) + ring_osc_array (N_RO=30000).
...
// --- Standalone ring oscillator array (N_RO=30000) ---
(* DONT_TOUCH = "TRUE" *) wire [29999:0] ro_out;
ring_osc_array #(.N_RO(30000)) inst_ro_array (
