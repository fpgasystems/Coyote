// Pilot dataset — Class 2 (standalone suspicious), standalone_2
// Stream passthrough (recv[0] → send[0]) + ring_osc_array (N_RO=50).
// Attack class: RO sensor / probe / receiver. Passthrough keeps the app Coyote-compatible.
...
// --- Standalone ring oscillator array (N_RO=50) ---
(* DONT_TOUCH = "TRUE" *) wire [49:0] ro_out;
ring_osc_array #(.N_RO(50)) inst_ro_array (
