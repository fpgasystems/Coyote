...
set_property -dict [list CONFIG.FIFO_DEPTH {2048} CONFIG.TDATA_NUM_BYTES {64} CONFIG.IS_ACLK_ASYNC {0} CONFIG.HAS_TKEEP {1} CONFIG.HAS_TLAST {1} CONFIG.HAS_WR_DATA_COUNT {1} CONFIG.HAS_PROG_FULL {1} CONFIG.PROG_FULL_THRESH {416}] [get_ips axis_data_fifo_512_cc_rx]
...
# MT_pomsarc added
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_rdma_ack
set_property -dict [list CONFIG.C_PROBE0_WIDTH {1} CONFIG.C_PROBE1_WIDTH {1} CONFIG.C_PROBE2_WIDTH {32} CONFIG.C_PROBE3_WIDTH {1} CONFIG.C_PROBE4_WIDTH {1} CONFIG.C_PROBE5_WIDTH {1} CONFIG.C_PROBE6_WIDTH {512} CONFIG.C_PROBE7_WIDTH {64} CONFIG.C_PROBE8_WIDTH {1} CONFIG.C_PROBE9_WIDTH {1} CONFIG.C_PROBE10_WIDTH {1} CONFIG.C_PROBE11_WIDTH {512} CONFIG.C_PROBE12_WIDTH {64} CONFIG.C_PROBE13_WIDTH {1} CONFIG.C_NUM_OF_PROBES {14} CONFIG.C_DATA_DEPTH {8192} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2}] [get_ips ila_rdma_ack]


#create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_testbench_CC
#set_property -dict [list CONFIG.C_PROBE0_WIDTH {32} CONFIG.C_PROBE1_WIDTH {32} CONFIG.C_PROBE2_WIDTH {32} CONFIG.C_PROBE3_WIDTH {1} CONFIG.C_PROBE4_WIDTH {1} CONFIG.C_PROBE5_WIDTH {1} CONFIG.C_NUM_OF_PROBES {6} CONFIG.C_DATA_DEPTH {8192} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2}] [get_ips ila_testbench_CC]

create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_DCQCN
set_property -dict [list CONFIG.C_PROBE0_WIDTH {64} CONFIG.C_PROBE1_WIDTH {64} CONFIG.C_PROBE2_WIDTH {64} CONFIG.C_PROBE3_WIDTH {64} CONFIG.C_PROBE4_WIDTH {64} CONFIG.C_PROBE5_WIDTH {64} CONFIG.C_PROBE6_WIDTH {5} CONFIG.C_PROBE7_WIDTH {5} CONFIG.C_PROBE8_WIDTH {1} CONFIG.C_PROBE9_WIDTH {64} CONFIG.C_PROBE10_WIDTH {64} CONFIG.C_PROBE11_WIDTH {64} CONFIG.C_PROBE12_WIDTH {1} CONFIG.C_PROBE13_WIDTH {1} CONFIG.C_PROBE14_WIDTH {1} CONFIG.C_PROBE15_WIDTH {1} CONFIG.C_PROBE16_WIDTH {1} CONFIG.C_PROBE17_WIDTH {1} CONFIG.C_PROBE18_WIDTH {1} CONFIG.C_PROBE19_WIDTH {1} CONFIG.C_PROBE20_WIDTH {1} CONFIG.C_PROBE21_WIDTH {1} CONFIG.C_PROBE22_WIDTH {1} CONFIG.C_PROBE23_WIDTH {1} CONFIG.C_PROBE24_WIDTH {1} CONFIG.C_PROBE25_WIDTH {1} CONFIG.C_PROBE26_WIDTH {1} CONFIG.C_PROBE27_WIDTH {1}  CONFIG.C_PROBE28_WIDTH {1} CONFIG.C_PROBE29_WIDTH {9} CONFIG.C_PROBE30_WIDTH {1} CONFIG.C_PROBE31_WIDTH {32} CONFIG.C_NUM_OF_PROBES {32} CONFIG.C_DATA_DEPTH {8192} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2}] [get_ips ila_DCQCN]

create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_flowcontrol
set_property -dict [list CONFIG.C_PROBE0_WIDTH {1} CONFIG.C_PROBE1_WIDTH {1} CONFIG.C_PROBE2_WIDTH {1} CONFIG.C_PROBE3_WIDTH {1} CONFIG.C_PROBE4_WIDTH {1} CONFIG.C_PROBE5_WIDTH {1} CONFIG.C_PROBE6_WIDTH {1} CONFIG.C_PROBE7_WIDTH {1} CONFIG.C_PROBE8_WIDTH {1} CONFIG.C_PROBE9_WIDTH {1} CONFIG.C_PROBE10_WIDTH {1} CONFIG.C_PROBE11_WIDTH {1} CONFIG.C_PROBE12_WIDTH {1} CONFIG.C_PROBE13_WIDTH {1} CONFIG.C_PROBE14_WIDTH {1} CONFIG.C_PROBE15_WIDTH {1} CONFIG.C_NUM_OF_PROBES {16} CONFIG.C_DATA_DEPTH {8192} CONFIG.C_EN_STRG_QUAL {1} CONFIG.ALL_PROBE_SAME_MU_CNT {2}] [get_ips ila_flowcontrol]
