...
#!!!ADJUST PATH!!!!
source "$build_dir/../examples/02_hls_vadd/hw/src/init_ip.tcl" -notrace

# add all the simulation files to the project         !!!ADJUST PATH!!!
set obj [get_filesets sources_1]
set files [list \
  [ file normalize "$build_dir/example_02_hls_vadd_config_0/user_c0_0/hdl/lynx_pkg.sv" ] \
  [ file normalize "$build_dir/example_02_hls_vadd_config_0/user_c0_0/hdl/vfpga_top.svh" ] \
  [ file normalize "$build_dir/../sim"] \
]
add_files -fileset $obj $files

# add wave behaviour            !!!ADJUST WAVEFORM!!!
add_files -fileset sim_1 -norecurse [ file normalize "$build_dir/../sim_files/waveforms/tb_user_behav_02.wcfg"]
