...
#!!!ADJUST PATH!!!!
source "$build_dir/../examples/07_perf_fpga/hw/src/init_ip.tcl" -notrace

# add all the simulation files to the project         !!!ADJUST PATH!!!
set obj [get_filesets sources_1]
set files [list \
  [ file normalize "$build_dir/example_07_perf_fpga_config_0/user_c0_0/hdl" ] \
  [ file normalize "$build_dir/../sim"] \
  [ file normalize "$build_dir/../hw/hdl/common/regs" ] \
]
add_files -fileset $obj $files

# add wave behaviour            !!!ADJUST WAVEFORM!!!
add_files -fileset sim_1 -norecurse [ file normalize "$build_dir/../sim_files/waveforms/tb_user_behav_07.wcfg"]
