...
#!!!ADJUST PATH!!!!
source "$build_dir/../examples/08_perf_rdma/hw/src/init_ip.tcl" -notrace

# add all the simulation files to the project         !!!ADJUST PATH!!!
set obj [get_filesets sources_1]
set files [list \
  [ file normalize "$build_dir/example_08_perf_rdma_config_0/user_c0_0/hdl" ] \
  [ file normalize "$build_dir/../sim"] \
]
add_files -fileset $obj $files

# add wave behaviour            !!!ADJUST WAVEFORM!!!
add_files -fileset sim_1 -norecurse [ file normalize "$build_dir/../sim_files/waveforms/tb_user_behav_08.wcfg"]
